...
public class PlayListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ImageView album = (ImageView) convertView.findViewById(R.id.view_playlist_row_album);
        ...
        PlayListAdapter.MyAsyncTask myAsyncTask = new PlayListAdapter.MyAsyncTask();
